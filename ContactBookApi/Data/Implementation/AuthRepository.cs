...
namespace ContactBookApi.Data.Implementation
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public bool UserExist(string loginId,string number,int userId)
        {
            var user = _appDbContext.Users.FirstOrDefault(c => (c.LoginId.ToLower() == loginId.ToLower() || c.ContactNumber.ToLower() == number.ToLower()) && c.userId != userId);
            if(user!=null)
            {
                return true;
            }
